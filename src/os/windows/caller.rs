...
use super::{entry::Entry, win32::Window};
...
use winapi::{
    ...
    um::{
        ...
        winuser::{
            CreateWindowExA, DestroyWindow, DispatchMessageA, PeekMessageA, TranslateMessage,
            HWND_MESSAGE, MSG, PM_REMOVE,
        },
    },
};
...
mod tests {
    ...
    #[async_std::test]
    async fn load_caller() -> Result<(), Box<dyn std::error::Error>> {
